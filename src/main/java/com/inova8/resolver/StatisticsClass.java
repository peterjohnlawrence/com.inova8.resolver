...
private static final double ErrorValue = -9999999999999.9;
private static final boolean NonIntegralValuesAllowed_df = false;
// Are non-integral degrees of freedom for t, chi_square and f distributions allowed?
private static final boolean NonIntegralValuesAllowed_NB = false;
// Is "successes required" parameter for negative binomial allowed to be non-integral?

private static final boolean NonIntegralValuesAllowed_Others = false;
// Can Int function be applied to parameters like sample_size or is it a fault if
// the parameter is non-integral?

private static final double nc_limit = 1000000.0;
...
private static final double lstpi = 0.918938533204673;
// 0.9189385332046727417803297364 = ln(sqrt(2*Pi))
private static final double sumAcc = 5E-16;
private static final double cfSmall = 1E-14;
private static final double cfVSmall = 1E-15;
private static final double minLog1Value = -0.79149064;
private static final double OneOverSqrTwoPi = 0.398942280401433;
// 0.39894228040143267793994605993438
private static final double scalefactor = 2 ^ 256; //1.15792089237316E+77;
// 1.1579208923731619542357098500869e+77 = 2^256  ' used for rescaling
//calcs w/o impacting accuracy, to avoid over/underflow
private static final double scalefactor2 = 2 ^ -256; //8.63616855509444E-78;
// 8.6361685550944446253863518628004e-78 = 2^-256
private static final double max_discrete = 2 ^ 53; //9.00719925474099E+15;
// 2^53 required for exact addition of 1 in hypergeometric routines
private static final double max_crit = 2 ^ 52; //4.5035996273705E+15;
// 2^52 to make sure plenty of room for exact addition of 1 in crit routines
private static final double nearly_zero = 9.99999983659714E-317;
private static final double cSmall = 5.562684646268E-309;
// (smallest number before we start losing precision)/4
private static final double t_nc_limit = 1.34078079299426E154;
// just under 1/Sqr(cSmall)
private static final double Log1p5 = 0.405465108108164;
// 0.40546510810816438197801311546435 = Log(1.5)
private static final double logfbit0p5 = 0.0548141210519177;
// 0.054814121051917653896138702348386 = logfbit(0.5)

//For logfbit functions
// Stirling's series for ln(Gamma(x)), A046968/A046969
private static final double lfbc1 = 1.0 / 12.0;
private static final double lfbc2 = 1.0 / 30.0;
// lfbc2 on are Sloane's ratio times 12
private static final double lfbc3 = 1.0 / 105.0;
private static final double lfbc4 = 1.0 / 140.0;
private static final double lfbc5 = 1.0 / 99.0;
private static final double lfbc6 = 691.0 / 30030.0;
private static final double lfbc7 = 1.0 / 13.0;
private static final double lfbc8 = 0.350686068964593;
// Chosen to make logfbit(6) & logfbit(7) correct
private static final double lfbc9 = 1.67699982016711;
// Chosen to make logfbit(6) & logfbit(7) correct

//For invcnormal                             ' http://lib.stat.cmu.edu/apstat/241
	// 3.3871328727963666080
private static final double a0 = 3.38713287279637;
	// 133.14166789178437745
private static final double a1 = 133.141667891784;
	// 1971.5909503065514427
private static final double a2 = 1971.59095030655;
	// 13731.693765509461125
private static final double a3 = 13731.6937655095;
	// 45921.953931549871457
private static final double a4 = 45921.9539315499;
	// 67265.770927008700853
private static final double a5 = 67265.7709270087;
	// 33430.575583588128105
private static final double a6 = 33430.5755835881;
	// 2509.0809287301226727
private static final double a7 = 2509.08092873012;
	// 42.313330701600911252
private static final double b1 = 42.3133307016009;
	// 687.18700749205790830
private static final double b2 = 687.187007492058;
	// 5394.1960214247511077
private static final double b3 = 5394.19602142475;
	// 21213.794301586595867
private static final double b4 = 21213.7943015866;
	// 39307.895800092710610
private static final double b5 = 39307.8958000927;
	// 28729.085735721942674
private static final double b6 = 28729.0857357219;
	// 5226.4952788528545610
private static final double b7 = 5226.49527885285;
////Coefficients for P not close to 0, 0.5 or 1.
	// 1.42343711074968357734
private static final double c0 = 1.42343711074968;
	// 4.63033784615654529590
private static final double c1 = 4.63033784615655;
	// 5.76949722146069140550
private static final double c2 = 5.76949722146069;
	// 3.64784832476320460504
private static final double c3 = 3.6478483247632;
	// 1.27045825245236838258
private static final double c4 = 1.27045825245237;
	// 0.241780725177450611770
private static final double c5 = 0.241780725177451;
	// 2.27238449892691845833E-02
private static final double c6 = 0.0227238449892692;
	// 7.74545014278341407640E-04
private static final double c7 = 0.000774545014278341;
	// 2.05319162663775882187
private static final double d1 = 2.05319162663776;
	// 1.67638483018380384940
private static final double d2 = 1.6763848301838;
	// 0.689767334985100004550
private static final double d3 = 0.6897673349851;
	// 0.148103976427480074590
private static final double d4 = 0.14810397642748;
	// 1.51986665636164571966E-02
private static final double d5 = 0.0151986665636165;
	// 5.47593808499534494600E-04
private static final double d6 = 0.000547593808499535;
	// 1.05075007164441684324E-09
private static final double d7 = 1.05075007164442E-09;
////Coefficients for P near 0 or 1.
	// 6.65790464350110377720
private static final double e0 = 6.6579046435011;
	// 5.46378491116411436990
private static final double e1 = 5.46378491116411;
	// 1.78482653991729133580
private static final double e2 = 1.78482653991729;
	// 0.296560571828504891230
private static final double e3 = 0.296560571828505;
	// 2.65321895265761230930E-02
private static final double e4 = 0.0265321895265761;
	// 1.24266094738807843860E-03
private static final double e5 = 0.00124266094738808;
	// 2.71155556874348757815E-05
private static final double e6 = 2.71155556874349E-05;
	// 2.01033439929228813265E-07
private static final double e7 = 2.01033439929229E-07;
	// 0.599832206555887937690
private static final double f1 = 0.599832206555888;
	// 0.136929880922735805310
private static final double f2 = 0.136929880922736;
	// 1.48753612908506148525E-02
private static final double f3 = 0.0148753612908506;
	// 7.86869131145613259100E-04
private static final double f4 = 0.000786869131145613;
	// 1.84631831751005468180E-05
private static final double f5 = 1.84631831751005E-05;
	// 1.42151175831644588870E-07
private static final double f6 = 1.42151175831645E-07;
	// 2.04426310338993978564E-15
private static final double f7 = 2.04426310338994E-15;

//For poissapprox                            ' Stirling's series for Gamma(x), A001163/A001164
private static final double coef15 = 1.0 / 12.0;
private static final double coef25 = 1.0 / 288.0;
private static final double coef35 = -139.0 / 51840.0;
private static final double coef45 = -571.0 / 2488320.0;
private static final double coef55 = 163879.0 / 209018880.0;
private static final double coef65 = 5246819.0 / 75246796800.0;
private static final double coef75 = -534703531.0 / 902961561600.0;
	// Ramanujan's series for Gamma(x+1,x)-Gamma(x+1)/2, A065973
private static final double coef1 = 2.0 / 3.0;
	// cf. http://www.whim.org/nebula/math/gammaratio.html
private static final double coef2 = -4.0 / 135.0;
private static final double coef3 = 8.0 / 2835.0;
private static final double coef4 = 16.0 / 8505.0;
private static final double coef5 = -8992.0 / 12629925.0;
private static final double coef6 = -334144.0 / 492567075.0;
private static final double coef7 = 698752.0 / 1477701225.0;

private static final double coef8 = 23349012224.0 / 39565450299375.0;
private static final double twoThirds = 2.0 / 3.0;
private static final double twoFifths = 2.0 / 5.0;
private static final double twoSevenths = 2.0 / 7.0;
private static final double twoNinths = 2.0 / 9.0;
private static final double twoElevenths = 2.0 / 11.0;

private static final double twoThirteenths = 2.0 / 13.0;
//For binapprox
private static final double oneThird = 1.0 / 3.0;
	// 2^27
private static final double twoTo27 = 134217728.0;

//For lngammaexpansion
	// 0.5772156649015328606065120901
private static final double eulers_const = 0.577215664901533;
...
private static double poisson1(double i, double N, double diffFromMean)
{
	...
	if ((i > sumAlways))
	{
		...
		Numb = (long)max(0, (int)(Numb - diffFromMean));
		if ((Numb > i))
		{
			Numb = (int)i;
		}
...
private static double poisson2(double i, double N, double diffFromMean)
{
	...
	long njj = 0;
	long Numb = 0;
	final long sumFactor = 6;
	Numb = (int)(sumFactor * Math.exp(Math.log(N) / 3));
	Numb = (long)max(0, (int)(diffFromMean + Numb));
...
private static double poissonApprox(double j, double diffFromMean, boolean comp)
{
	double functionReturnValue = 0;
...
private static double lngammaexpansion(double a)
{
	...
	double[] coeffs = {0.322467033424113, 0.0673523010531981, 0.0205808084277845, 0.00738555102867399, 0.00289051033074152, 0.00119275391170326, 0.000509669524743042, 0.000223154758453579, 9.94575127818085E-05, 4.49262367381331E-05, 2.05072127756707E-05, 9.4394882752684E-06, 4.37486678990749E-06, 2.03921575380137E-06, 9.55141213040742E-07, 4.49246919876457E-07, 2.12071848055547E-07, 1.00432248239681E-07, 4.76981016936398E-08, 2.27110946089432E-08, 1.0838659214897E-08, 5.18347504197005E-09, 2.48367454380248E-09, 1.19214014058609E-09, 5.73136724167886E-10, 2.75952288512423E-10, 1.33047643742445E-10, 6.4229645638381E-11, 3.10442477473223E-11, 1.50213840807541E-11, 7.27597448023908E-12, 3.52774247657592E-12, 1.71199179055962E-12, 8.31538584142029E-13, 4.04220052528944E-13, 1.96647563109662E-13, 9.57363038783856E-14, 4.66407602642837E-14, 2.27373696006597E-14, 1.10913994708345E-14, 2.27373684582465E-13};
	double lgam = 0;
	int i = 0;
...
private static double invincgamma(double a, double prob, boolean comp)
{
	double functionReturnValue = 0;
...
protected static double inv_normal(double prob)
{
	double functionReturnValue = 0;
...
protected static double inv_chi_sq(double prob, double df)
{
	double functionReturnValue = 0;
